...
# Please configure the following URL before use
url_start='[URL of the first page]'
url_source="[URL of the home page]"
url_contentPage='[URL of the catalog page]'
url_coverimage='[URL of the catalog image]'
